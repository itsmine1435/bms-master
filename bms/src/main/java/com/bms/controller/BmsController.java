...
public class BmsController {
	...
	{
		 logger.info("searchMovieByMultiplex:{}" + mid);	
	...
	@ApiOperation(value = "Get details of movie by selected Address" , response = NameDTO.class)
	@GetMapping("/searchMovieByAddress/{aid}")
	public List<NameDTO> searchMovieByAddress(@PathVariable Long aid)
	{
		 logger.info("searchMovieByAddress:{}" + aid);	
		 List<NameDTO> dtos = bmsService.searchMoviesByAddress(aid);
		 return dtos;
	}
